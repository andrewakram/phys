...
class OrderRepository implements OrderRepositoryInterface
{
    ...
    {
        return Order::with(['user','worker' ,'category'])->latest()->paginate(50);
    }
    ...
    {
        $order = Order::whereId($id)->select('id','user_id','cat_id','lat','lng')->first();
        $filter_order = Order::filterbylatlng($order->lat,$order->lng,50,'workers',$order->cat_id);
