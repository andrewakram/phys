    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <form method="post" action="{{route('searchQuerries')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <select name="test_id" class="btn btn-default border-dark form-control b-light digits">
                            ...
                            <table id="tech-companies-1" class="table  table-bordered">
                                ...
                                @foreach($results as $result)
                                    <tr>
                                                ...
                                                <div class="modal fade" id="answer{{$result->id}}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        ...
                                                        <div class="modal-content p-3">
                                                            ...
                                                            {{--                                                                <hr class=" ">--}}
                                                            {{--                                                            </div>--}}
                                                            @foreach($result->replies as $answer)
                                        ...
                                        <td>
                                            @if($result->test)
                                                <span>#: </span> <b>{{$result->test->id}}</b> <br>
                                                <span>اسم الامتحان: </span> <b>{{$result->test->name}}</b> <br>
                                                {{--                                        {{$result->group->test_id}}--}}
                                            @else
                                                <b> - </b>
                                            @endif
                                        </td>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <select name="test_id"
                                                                    ...
                                                                    @foreach($tests as $test)
                                                                        <option
                                                                            value="{{$test->id}}" {{$test->id == $result->test->id ? "selected" : ""}}>{{$test->name}}</option>
                                                                    @endforeach
                                                                </select>
                                    ...
                                    <div class="modal animated fadeIn" id="delete_{{$result->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="{{route('deleteQuerry')}}"
                                                      class="buttons">
                                                    {{csrf_field()}}
                                                    <div class="modal-body">
                                                        <h4>هل انت متأكد ؟</h4>
                                                        <h6>
                                                            ...
                                                            <br>تابع للامتحان: ({{$result->test->test_num}}
                                                            / {{$result->test->name}})
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal needs-validation was-validated" method="post"
                      action="{{route('addQuerry')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-12 control-label text-lg-right"
                                   for="textinput">الامتحانات</label>
                            <div class="col-lg-12">
                                <select name="test_id" class="btn form-control b-light digits"
                                        required
                                        oninvalid="this.setCustomValidity('هذا الحقل مطلوب ادخاله')">
                                    <option value="" disabled>اختر الامتحان</option>
                                    @foreach($tests as $test)
