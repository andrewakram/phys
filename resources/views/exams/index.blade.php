    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <form method="post" action="{{route('searchExams')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post"
                                                      action="{{route('editExam')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
    ...
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal needs-validation was-validated" method="post" action="{{route('addExam')}}"
