...
<div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="mini-stat clearfix bg-white">
                            ...
                            <div class="mini-stat-info pull-left">
                                <span class="counter text-purple">{{$users}}</span>
                                الطلاب
                            </div>
...
{{--                            <p class=" mb-0 m-t-20 text-muted">Total income: $22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>--}}
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="mini-stat clearfix bg-white">
                            ...
                            <div class="mini-stat-info pull-left">
                                <span class="counter text-blue-grey">{{$groups}}</span>
                                المجموعات
                            </div>
                            <div class="clearfix"></div>
{{--                            <p class="text-muted mb-0 m-t-20">Total income: $22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>--}}
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="mini-stat clearfix bg-white">
                            ...
                            <div class="mini-stat-info pull-left">
                                <span class="counter text-brown">{{$exams}}</span>
                                الاختبارات
                            </div>
                            <div class="clearfix"></div>
{{--                            <p class="text-muted mb-0 m-t-20">Total income: $22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>--}}
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="mini-stat clearfix bg-white">
                            ...
                            <div class="mini-stat-info pull-left">
                                <span class="counter text-teal">{{$questions}}</span>
                                الاسئلة
                            </div>
                            <div class="clearfix"></div>
{{--                            <p class="text-muted mb-0 m-t-20">Total income: $22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>--}}
