...
{{--                                    <div class="dropdown-divider"></div>--}}
                                    <a class="dropdown-item" href="{{route('logout')}}"><i class="dripicons-exit text-muted"></i> تسجيل الخروج</a>
                                </div>
                            </li>
...
{{--                            </li>--}}
                            ...
                            <li>
                                <a href="{{route('stages')}}" ><i class="mdi mdi-airplane"></i>المراحل الدراسية</a>
                            </li>
                            <li>
